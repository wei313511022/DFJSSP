...
def plot_routes(time_steps, agv_routes, total_time_steps):
    ...
    plt.title('paper_5AMR_10TASK_NOJIT')
...
if __name__ == "__main__":
    try:
        ...
        # --- 2. 建立 Gurobi 模型 ---
        model = gp.Model("Min_Total_Completion_Time_Routing")
        
        model.setParam('TimeLimit', 3600)  
        model.setParam('MIPGap', 0.0)     
        
        print(f"Gurobi 模型已建立，目標：最小化總完成時間 (TimeLimit=3600s)")
